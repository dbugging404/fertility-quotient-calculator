...
function computeQuotient() {
  ...
  //Show Remarks
  if (score <= 18)  {
    document.getElementById("result").innerHTML = "Poor Fertility";
    ...
    document.getElementById("result").innerHTML = "Low Fertility";
    ...
    document.getElementById("result").innerHTML = "Average Fertility";
    document.getElementById('low-fertility').setAttribute('style', 'display:none');
    ...
    document.getElementById("result").innerHTML = "Good Fertility";
    document.getElementById('low-fertility').setAttribute('style', 'display:none');
    document.getElementById('average-fertility').setAttribute('style', 'display:none');
    ...
    document.getElementById("result").innerHTML = "Best Fertility";
    document.getElementById('low-fertility').setAttribute('style', 'display:none');
    document.getElementById('average-fertility').setAttribute('style', 'display:none');
    document.getElementById('good-fertility').setAttribute('style', 'display:none');
    ...
    document.getElementById("result").innerHTML = "Not Applicable"; 
    document.getElementById("percentage").innerHTML = "Not Applicable";
    document.getElementById("score").innerHTML = "Not Applicable";
  }    
}
